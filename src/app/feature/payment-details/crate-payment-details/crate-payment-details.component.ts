...
@Component({
  ...
  templateUrl: './crate-payment-details.component.html',
  styleUrls: ['./crate-payment-details.component.css']
})
export class CratePaymentDetailsComponent implements OnInit {
